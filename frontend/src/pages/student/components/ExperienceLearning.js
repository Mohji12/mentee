...
const ExperienceLearning = () => {
  ...
  const fetchEntries = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/student/${student_usn}/experience-learning`, {
        headers: {
    ...
    try {
      ...
      if (isEditing && currentEntry) {
        ...
        const response = await fetch(
          `${API_BASE_URL}/student/${student_usn}/experience-learning/${currentEntry.id}`,
          {
            method: 'PUT',
            headers: {
        ...
        // Create new entry
        const response = await fetch(
          `${API_BASE_URL}/student/${student_usn}/experience-learning`,
          {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
  ...
  const uploadProof = async (entryId) => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/student/${student_usn}/experience-learning/${entryId}/upload-proof`,
        {
          method: 'POST',
          headers: {
            'Authorization': `Bearer ${token}`,
  ...
  const handleDelete = async (entryId) => {
    ...
    try {
      const token = sessionStorage.getItem('access_token');
      const response = await fetch(
        `${API_BASE_URL}/student/${student_usn}/experience-learning/${entryId}`,
        {
          method: 'DELETE',
          headers: {
            'Authorization': `Bearer ${token}`,
