...
const WorkingCommitteeStats = () => {
  ...
  useEffect(() => {
    ...
    fetch(`${API_BASE_URL}/working-committee/${member_id}/stats`, {
  ...
  return (
    <div className="admin-dashboard__main-content leader-dashboard">
      <header className="leader-stats__header">
        <h1 className="leader-stats__title">Committee Dashboard</h1>
        <p className="leader-stats__subtitle">Overview of your allocated departments.</p>
      </header>
...
export default WorkingCommitteeStats;
