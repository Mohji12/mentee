...
class Login(Base):
    ...
    ms_ids = Column(String, nullable=False)  # User ID (ms_ids, student_usn, or mentor_id)
    ...
    access_token = Column(String, nullable=False)  # Access token for the login session
    jti = Column(String, nullable=False)  # JWT ID for uniquely identifying the token
