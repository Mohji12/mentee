...
class MentorActivityRequest(BaseModel):
    """Schema for mentor to request/create an activity for a student"""
    student_usn: str
    activities: str  # Activity description/details
    duration_type: str  # "Short Term", "Mid Term", or "Long Term"
    deadline: Optional[datetime] = None  # Optional custom deadline, will be calculated if not provided
    remarks: Optional[str] = None  # Optional remarks/instructions for the student

class StudentActivityRequest(BaseModel):
    """Schema for student to request/create a new activity"""
    activities: str  # Activity description/details
    duration_type: str  # "Short Term", "Mid Term", or "Long Term"
    deadline: Optional[datetime] = None  # Optional custom deadline, will be calculated if not provided
    remarks: Optional[str] = None  # Optional remarks/notes for the mentor
