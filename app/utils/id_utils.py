...
def generate_session_id():
    """Generate a unique attendance session ID in the format 'SESS' + 12 random characters."""
    return "SESS" + ''.join(random.choices(string.ascii_uppercase + string.digits, k=12))